...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { id: 1, name: 'Vestido elegante', description: 'Perfecto para ocasiones especiales.', price: 49.99, image: '/img/ropa1.jpg' },
        { id: 2, name: 'Jersey cómodo', description: 'Ideal para los días fríos de invierno.', price: 29.99, image: '/img/ropa2.jpg' },
        { id: 3, name: 'Pantalones casuales', description: 'Perfectos para una jornada informal.', price: 39.99, image: '/img/ropa3.jpg' },
        { id: 4, name: 'Chaqueta estilo vintage', description: 'Un clásico para cualquier temporada.', price: 59.99, image: '/img/ropa4.jpg' },
      ],
    };
  },
  computed: {
